...
const DOCUMENTATION_COLUMN_AI_BY_TABLE = Object.freeze({
  ...
  "eiz-zuds": Object.freeze({
    ...
    iisk: makeColumnAi({
      ...
      examples: ["23", "78", "210", "=IF(F3=\"\",\"\",RANDBETWEEN(70,80)*F3/100)"],
      validationRules: `Ako je vrijednost prepisana iz starog zapisnika, sacuvaj decimalni separator i jedinicu ukloni. ${EIZ_MEASUREMENT_FORMULA_RULE}`,
    ...
    tisk: makeColumnAi({
      ...
      examples: ["18", "24", "156", "=IF(F3=\"\",\"\",RANDBETWEEN(14,24))"],
    ...
    pass: makeColumnAi({
      ...
      commonValues: ["DA"],
      fallbackValue: "",
      validationRules: "Ako je Iisk veci ili jednak I delta n ili je tisk izvan dopustene granice, vrati NE. Ako nema dovoljno podataka, ostavi prazno ili postojecu formulu.",
      confidenceRequired: "high",
    }),
  }),
  ...
  "eiz-oi": Object.freeze({
    ...
    l123: makeColumnAi({
      ...
      examples: [">30", "200", "50"],
      validationRules: "Sacuvaj znak >, decimalni separator i redoslijed iz izvora. Ne izmisljaj Riso vrijednost ako nije vidljiva.",
      confidenceRequired: "high",
    }),
    l123n: makeColumnAi({
      key: "l123n",
      ...
      examples: [">30", "200"],
      validationRules: "Sacuvaj znak >, decimalni separator i redoslijed iz izvora. Ne popunjavaj iz drugih Riso kolona osim ako izvor jasno koristi istu skupnu vrijednost.",
      confidenceRequired: "high",
    }),
    l123pe: makeColumnAi({
      key: "l123pe",
      ...
      examples: [">30", "200"],
      validationRules: "Sacuvaj znak >, decimalni separator i redoslijed iz izvora. Ne popunjavaj ako je vidljiv samo IPK ili ZUDS redak.",
      confidenceRequired: "high",
    }),
    npe: makeColumnAi({
      key: "npe",
