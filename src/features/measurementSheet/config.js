export const DEFAULT_MEASUREMENT_ROW_COUNT = 72;
export const MEASUREMENT_ROW_BATCH_SIZE = 48;
export const MIN_VISIBLE_MEASUREMENT_ROWS = 120;
export const MEASUREMENT_COMPUTE_DEBOUNCE_MS = 90;
export const MEASUREMENT_VIRTUALIZATION_MIN_ROWS = 96;
export const MEASUREMENT_VIRTUALIZATION_MIN_CELLS = 1800;
export const MEASUREMENT_VIRTUALIZATION_OVERSCAN_ROWS = 18;
export const MEASUREMENT_COLUMN_VIRTUALIZATION_MIN_COLUMNS = 22;
export const MEASUREMENT_COLUMN_VIRTUALIZATION_MIN_CELLS = 2600;
...
export const MEASUREMENT_LOCAL_DRAFT_DELAY_MS = 900;
